...
export function CalendarKit({
  ...
  const [events, setEvents] = React.useState<FivFoldCalendarEvent[]>(initialEvents)
  ...
  // Detail dialog state
  const [detailEvent, setDetailEvent] = React.useState<FivFoldCalendarEvent | null>(null)
  const [detailOpen, setDetailOpen] = React.useState(false)

  // Create/edit dialog state
  const [createOpen, setCreateOpen] = React.useState(false)
  const [createInitialDate, setCreateInitialDate] = React.useState<Date | undefined>(undefined)
  const [editEvent, setEditEvent] = React.useState<FivFoldCalendarEvent | null>(null)
