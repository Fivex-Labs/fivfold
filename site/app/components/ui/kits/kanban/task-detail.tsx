...
export interface TaskDetailProps {
  ...
  /** When set (e.g. in device preview), dialog renders inside this container */
  container?: HTMLElement | null
  /** When "mobile", dialog goes full-screen and uses vertical layout */
  forceLayout?: "mobile" | "tablet" | "desktop"
}

export function TaskDetail({ task, open, onOpenChange, container, forceLayout }: TaskDetailProps) {
  if (!task) return null
