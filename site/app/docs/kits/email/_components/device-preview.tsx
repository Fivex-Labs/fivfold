...
import { EmailKit, type EmailKitProps } from "@/components/ui/kits/email";
...
interface DevicePreviewProps {
  ...
  fontFamily: string;
  emailKitProps: Omit<EmailKitProps, "forceLayout">;
}
...
export function DevicePreview({
  ...
  const forceLayout: EmailKitProps["forceLayout"] =
            ...
            >
              ...
              >
                <div
                  ...
                  className="relative h-[80vh] min-h-[500px] w-full min-w-0 overflow-hidden"
                  style={{
