...
import { CalendarKit, type CalendarKitProps } from "@/components/ui/kits/calendar/index";
...
interface DevicePreviewProps {
  ...
  fontFamily: string;
  calendarKitProps: Omit<CalendarKitProps, "forceLayout">;
}
...
export function DevicePreview({
  ...
  const forceLayout: CalendarKitProps["forceLayout"] =
    deviceSize === "mobile" ? "mobile" : deviceSize === "tablet" ? "tablet" : "desktop";
        ...
        >
          ...
          <div className="flex flex-1 items-center justify-center overflow-auto p-8">
            ...
            >
              ...
              >
                <div
                  className="relative h-[80vh] min-h-[500px] w-full min-w-0 overflow-hidden p-4"
                  style={{
